...
install: neoterm-services
	...
	mkdir -p $(DESTDIR)$(PREFIX)/share/neoterm-services
	install svlogger $(DESTDIR)$(PREFIX)/share/neoterm-services
...
uninstall:
	...
	rm -rf $(DESTDIR)$(PREFIX)/share/neoterm-services
